...
export const ManualDisplay = ({
  ...
  const [message, setMessage] = useState(`http://localhost:3000 wants you to sign in with your Ethereum account:\n0xf1F7198d9AE8c6975F43d2303D3D9aDea3821864\n\nBy signing in, you agree to the privacy policy and terms of service.\n\nURI: http://localhost:3000\nVersion: 1\nChain ID: 1\nNonce: *\nIssued At: 2024-02-07T13:17:27.365Z\nExpiration Time: 2024-02-14T13:17:27.365Z\nResources:\nAsset Ownership Requirements:\n- Requirement A-1:\n    Chain: BitBadges\n    Collection ID: 1\n    Asset IDs: 9 to 9\n    Ownership Time: Authentication Time\n    Ownership Amount: x0\n\n`);
  const [signature, setSignature] = useState('0x95f200aa19798984e7d8ba733c5076df35c4a0f98c3af38f8e63bba09e9339f456abb34166b23ad50f128497519f3b8758712c8c95c7319b78424487bc35e42a1b');
  ...
  return <>
    ...
    <div className='text-center secondary-text px-10'>
      The manual option is when the user manually provides you with their message and signature.
